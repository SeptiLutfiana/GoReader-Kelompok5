...
const char* password = "palingbahagia";
const char* serverUrl = "http://34.128.87.121:5000/upload";
...
void setup() {
  ...
  // Set timezone dan sinkronisasi waktu dengan NTP server (WIB is UTC+7)
...
void loop() {
  ...
  // Tunggu sebelum memeriksa waktu lagi
  delay(1000);
}
